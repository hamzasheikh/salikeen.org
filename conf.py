...
# BASE_URL = "http://www.salikeen.org/"
BLOG_EMAIL = "getintouch@salikeen.org"
BLOG_DESCRIPTION = "Books written by Late Major (Retired) Muhammad Mahmood Ahmed Khan"  # (translatable)
